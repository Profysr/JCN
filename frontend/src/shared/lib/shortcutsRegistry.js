...
export const SHORTCUT_GROUPS = [
  ...
  },
  {
    ...
    shortcuts: [
      { id: "task:edit-title",  keys: ["e"],       display: ["e"],       description: "Edit task title" },
      { id: "task:assign",      keys: ["a"],       display: ["a"],       description: "Assign task" },
      { id: "task:status",      keys: ["s"],       display: ["s"],       description: "Change status" },
      { id: "task:priority",    keys: ["p"],       display: ["p"],       description: "Change priority" },
      { id: "task:label",       keys: ["l"],       display: ["l"],       description: "Add / remove label" },
      { id: "task:due-date",    keys: ["d"],       display: ["d"],       description: "Set due date" },
      { id: "task:copy-link",   keys: ["y"],       display: ["y"],       description: "Copy task link" },
      { id: "task:clone",       keys: ["Shift+D"], display: ["⇧", "D"], description: "Clone task" },
      { id: "task:open-approval", keys: ["Shift+V"], display: ["⇧", "V"], description: "Open approval dropdown" },
      { id: "task:child-new",   keys: ["n"],       display: ["n"],       description: "Add child task" },
      { id: "task:child-attach", keys: ["Shift+N"], display: ["⇧", "N"], description: "Attach existing child task" },
      { id: "task:subtask-new", keys: ["Shift+S"], display: ["⇧", "S"], description: "Add subtask / checklist item" },
    ],
  },
  {
    id: "task_panel",
    ...
    shortcuts: [
      { id: "panel:tab-comments",  keys: ["1"], display: ["1"], description: "Switch to Comments tab" },
      { id: "panel:tab-activity",  keys: ["2"], display: ["2"], description: "Switch to Activity tab" },
      { id: "panel:tab-approvals", keys: ["3"], display: ["3"], description: "Switch to Approvals tab" },
      { id: "panel:focus-comment", keys: ["i"], display: ["i"], description: "Focus comment input" },
    ],
  },
  {
    id: "my_work",
