import {
  ...
  BarChart2, FileBarChart, Plug, Key, Webhook, Upload,
} from "lucide-react";
...
export const NAV_ITEMS = [
  ...
  { key: "analytics",  icon: BarChart2,       label: "Analytics",  desc: "Velocity, flow & team metrics", path: "analytics" },
  { key: "reports",    icon: FileBarChart,    label: "Reports",    desc: "Custom charts & scheduled delivery", path: "reports" },
  ...
  { key: "integrations",  icon: Plug,         label: "Integrations", desc: "Slack, Teams, Google Chat",             path: "settings/integrations" },
  { key: "api-keys",      icon: Key,          label: "API Keys",     desc: "Programmatic API access",               path: "settings/api"          },
  { key: "webhooks",      icon: Webhook,      label: "Webhooks",     desc: "Outbound event webhooks",               path: "settings/webhooks"     },
  { key: "import",        icon: Upload,       label: "Import",       desc: "Migrate from Jira, Trello, ClickUp…",   path: "settings/import"       },
...
export const NAV_GROUPS = [
  ...
  {
    label: "Workspace",
    items: ["members", "integrations", "api-keys", "webhooks", "import", "settings"],
  },
];
