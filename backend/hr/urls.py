...
from .views import (
    ...
    HolidayDetailView,
    HolidayCountriesView,
    HolidaySuggestionsView,
...
urlpatterns = [
    ...
    path(f"{_ws}/hr/holidays/countries/", HolidayCountriesView.as_view()),
    path(f"{_ws}/hr/holidays/suggestions/", HolidaySuggestionsView.as_view()),
    path(f"{_ws}/hr/holidays/bulk/", HolidayBulkCreateView.as_view()),
